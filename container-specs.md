...
| LABEL about.home            | The original software website where  and examples.   | **Mandatory** | about.home: http://comet-ms.sourceforge.net/  |
...
| LABEL about.license         | SPDX license specification. If not in the SPDX listspecify URL in license_file> | **Mandatory** | about.license: SPDX:Apache-2.0          |
